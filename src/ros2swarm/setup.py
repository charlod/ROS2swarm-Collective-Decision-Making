...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'launch', 'pattern', 'decision_making_pattern', 'combined'),
         glob('launch/pattern/decision_making_pattern/combined/*.launch.py')),
        ...
        (os.path.join('share', package_name, 'config', 'turtlebot4', 'decision_making_pattern'),
         glob('config/turtlebot4/decision_making_pattern/*.yaml')),
        ...
        (os.path.join('share', package_name, 'launch', 'pattern', 'decision_making_pattern', 'combined'),
         glob('launch/pattern/decision_making_pattern/combined/*.yaml')),
    ...
    entry_points={
        'console_scripts': [
            ...
            'binary_discrimination_pattern = '
            'ros2swarm.decision_making_pattern.combined.binary_discrimination_pattern:main',
        ],
    },
)
