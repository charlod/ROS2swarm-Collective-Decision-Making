...
def generate_launch_description():
    """Start the nodes required for the neighbor finder pattern."""
    ...
    ros2_pattern_node = launch_ros.actions.Node(
        package='ros2swarm',
        executable='neighbor_finder_pattern',
        namespace=robot_namespace,
        output='screen',
        parameters=[
            PathJoinSubstitution([config_dir, 'decision_making_pattern', 'basic', 'neighbor_finder_pattern.yaml'])],
