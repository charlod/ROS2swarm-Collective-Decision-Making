...
def generate_launch_description():
    """Start the nodes required for the phototaxis pattern."""
    ...
    ros2_pattern_node = launch_ros.actions.Node(
        package='ros2swarm',
        executable='phototaxis_pattern',
        namespace=robot_namespace,
        output='screen',
        parameters=[
            PathJoinSubstitution([config_dir, 'movement_pattern', 'basic', 'phototaxis_pattern.yaml'])],
