...
def generate_launch_description():
    """Start the nodes required for the antiphototaxis pattern."""
    ...
    ros2_pattern_node = launch_ros.actions.Node(
        package='ros2swarm',
        executable='antiphototaxis_pattern',
        namespace=robot_namespace,
        output='screen',
        parameters=[
            PathJoinSubstitution([config_dir, 'movement_pattern', 'basic', 'antiphototaxis_pattern.yaml'])],
