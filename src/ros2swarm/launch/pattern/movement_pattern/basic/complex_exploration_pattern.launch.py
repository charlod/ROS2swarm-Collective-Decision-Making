...
def generate_launch_description():
    """Start the nodes required for the complex exploration pattern."""
    ...
    ros2_pattern_node = launch_ros.actions.Node(
        package='ros2swarm',
        executable='complex_exploration_pattern',
        namespace=robot_namespace,
        output='screen',
        parameters=[
            PathJoinSubstitution([config_dir, 'movement_pattern', 'basic', 'complex_exploration_pattern.yaml'])],
